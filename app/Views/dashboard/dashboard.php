            ...
            <div class="card-content">
                <div class="row">
                    ...
                    <div class="col s2 right-align">
                        <a href="<?= base_url('serverside/add-employee') ?>"
                            class="btn-floating waves-effect waves-light grenn"><i
                                class="small material-icons">add</i></a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <ul class="tabs">
                            ...
                            <li class="tab col s3"><a class="blue-text" href="#datatable_excel">DataTable Excel </a>
                            </li>
                        </ul>
                    </div>
                    <div class="char-container">
                        <div id="datatable" class="col s12">
                            <div class="row">
                                ...
                                <div class="col s2 right-align">
                                    <a title="Download Excel" href="<?= route_to('download.excel') ?> ?>"
                                        class="btn-floating waves-effect waves-light grenn"><i
                                            class="small material-icons">file_download</i></a>
                                </div>
                            </div>
